...
#include "GraphicsPlatform/Vulkan/ImGui/ImGuiLayerVulkan.h"

#include <GLFW/glfw3.h>
#include <vulkan/vulkan.h>

#ifdef SPITFIRE_TARGET_DEBUG
...
namespace Spitfire
{
	...
	ApplicationVulkan::ApplicationVulkan(const std::string& name, uint32_t width, uint32_t height)
	...
	void ApplicationVulkan::Create()
	{
		...
		m_ImGuiLayer = std::make_shared<ImGuiLayerVulkan>();
		PushLayer(m_ImGuiLayer);
	}

	void ApplicationVulkan::Destroy()
	{
		DestroyLayer();
		DestroyGLFW();
